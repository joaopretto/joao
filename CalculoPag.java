...
public class CalculoPag { 
	...
	public CalculoPag(int horastrabalho, double salariohora, int dependentes) {
			this.horastrabalho = horastrab;
	...
	public double calculoSalarioBruto() {
		return salariobruto = horastrabalho * salariohora + (50 * dependentes);
	}
